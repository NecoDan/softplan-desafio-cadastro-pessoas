...
@ToString
@Entity
@Table(name = "sp03_tipo_operacao_log", schema = "softplan_services")
...
public class TipoOperacaoLog implements Serializable {
    ...
    public boolean isUpdate() {
        return (isIdValido() && this.tipoOperacaoLogEnum.isUpdate());
    }

    @JsonIgnore
    public boolean isDelete() {
        return (isIdValido() && this.tipoOperacaoLogEnum.isDelete());
    }
